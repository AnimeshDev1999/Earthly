  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-start w-3/4">
        ...
        <Fade bottom cascade>
          <p className="text-2xl mb-6">High quality eco friendly products</p>
        </Fade>
        <Fade bottom cascade>
          <button className="bg-green-800 text-2xl rounded-lg font-semibold px-5 py-3 cursor-pointer">
            Switch to Earthly
          </button>
        </Fade>
      </div>
