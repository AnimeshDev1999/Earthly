...
const Header = () => {
  return (
    <header className="sm:hidden md:hidden lg:flex absolute top-0 left-0 justify-between content-center py-5 md:px-3 lg:px-9 bg-gradient-to-b from-black h-32 w-full">
